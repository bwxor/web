...
function MessageBox(props: ChatBoxProps) {
    ...
    const DUMMY_MESSAGES: Message[] = [
        ...
        {id: "m5", senderId: auth.id, receiverId: props.id, content: "Hey! Did you finish that report yet?"},
        {
            ...
            senderId: props.id,
            receiverId: auth.id,
            content: "Just about. I'm just double-checking the charts."
        },
        {id: "m7", senderId: auth.id, receiverId: props.id, content: "Great, no rush. I was just curious."},
        {
            ...
            senderId: props.id,
            receiverId: auth.id,
            content: "Actually, can you take a look at the third page?"
        },
        ...
        {id: "m11", senderId: auth.id, receiverId: props.id, content: "Got it. Looks solid at first glance."},
        {
            ...
            senderId: props.id,
            receiverId: auth.id,
            content: "Awesome. Do we need to meet with the design team?"
        },
        ...
        {id: "m18", senderId: props.id, receiverId: auth.id, content: "Yeah? What's up?"},
        {
            ...
            senderId: auth.id,
            receiverId: props.id,
            content: "Did you see the latest update on the Jira ticket?"
        },
        {id: "m20", senderId: props.id, receiverId: auth.id, content: "Not yet, I've been offline for an hour."},
        {
            ...
            senderId: auth.id,
            receiverId: props.id,
            content: "The client wants the logo to be slightly larger."
        },
        ...
        {id: "m48", senderId: props.id, receiverId: auth.id, content: "Good call. I'll check."},
        {
            ...
            senderId: auth.id,
            receiverId: props.id,
            content: "By the way, are you coming to the party Friday?"
        },
